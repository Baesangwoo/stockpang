...
namespace StockPang.Controllers
{
    public class HomeController : Controller
    {
                        ...
                        string Search_per, string Search_biz_rate, string Search_net_rate)
        {
            ...
            data = modelList1.GetSearchData(Search_name, Search_class, Search_psr, Search_por, Search_per, Search_biz_rate, Search_net_rate, "User", userID);
            ...
            return View("~/List1/StockList", data);
        }
